...
export default function HeaderBar({}) {
  return (
    <div className="w-full transition-all duration-300 bg-white overflow-hidden md:overflow-visible max-w-[1600px] h-[93px] md:h-[84px] md:pt-3">
      <div className="flex transition-all duration-300 gap-[10px] flex-col px-4 smm:px-5 md:px-8 py-2.5 md:gap-10 md:py-2 md:flex-row md:items-center lg:gap-15">
        ...
        <div className="items-center flex-shrink-0 hidden w-auto gap-10 lg:flex">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="relative flex flex-col items-center justify-between text-theme-500"
          >
